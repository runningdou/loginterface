...
def usr_sign_up():
    def sign_to_Mofan_Python():
        ...
        if np != npf:
            tk.messagebox.showerror('Error','Password and confirm password must bethe same')
    ...
    usr_pwd_confirm = tk.Entry(window_sign_up,textvariable=new_pwd_confirm)
    usr_pwd_confirm.place(x=150,y=90)
